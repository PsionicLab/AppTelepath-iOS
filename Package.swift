...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Telepath",
            url: "https://github.com/PsionicLab/AppTelepath-iOS/releases/download/3.1.0/Telepath-3.1.0.zip",
            checksum: "73e57ba017b01237265328439cd62b9ce5c0e98efcb09750ac783a4964d5b521"
        ),
